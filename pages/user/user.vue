    ...
    <div v-if="type === 1 || type === 3">
      <div class="box-title">
        ...
        <div class="my-img-box">
          <img
            ...
            :src="
              coverImage === ''
                ? 'https://www.zairongyifang.com:8080/filePath/app/20245/compressed_3cb0cd9dbf.png'
                : coverImage
            "
            alt=""
          />
        ...
        <div class="people-and-do-some">
            ...
            <div class="cost-start">
              <div class="cost-level">
                <img
                  ...
                  alt=""
                />
                <div v-if="[1, 2, 3].includes(vipLevel)" class="level-img-says">
                  LV{{ nmberLevel }}
                </div>
          ...
          <div class="do-some">
            ...
            <div class="sgpp" @click="goFruit">
              <img src="../../static/sgpp.png" alt="" />
            </div>
            <div class="chat" @click="goSafeRoad">
              <img src="../../static/chat.png" alt="" />
              <div class="dots-chat">
                <u-badge :isDot="chatDot"></u-badge>
              </div>
            </div>
            <div class="kjxy" @click="goSpaceRun">
              <img src="../../static/kjxy.png" alt="" />
            </div>
            <div class="tss" @click="toOtherUser2">
              <img src="../../static/tss.png" alt="" />
            </div>
            <div class="sxx" @click="goIndex2">
              <div class="dots">
                <u-badge :isDot="messageDot"></u-badge>
              </div>
              <img src="../../static/sxx.png" alt="" />
            </div>
          </div>
        </div>
      </div>
      ...
      >
        ...
        <div class="list-title">
          ...
          <text v-if="!i.postTop" class="get-top" @click.stop="setTop(i)"
            >设为置顶</text
          >
          <text v-if="i.postTop" class="get-top" @click.stop="unSetTop(i)"
            >取消置顶</text
          >
        </div>
        <!-- 图 -->
...
export default {
  ...
  methods: {
    ...
    goCurrentBottle() {
      uni.navigateTo({
        url: '../currentBottle/currentBottle',
      });
    },
    //去水果拼盘
    goFruit() {
      uni.navigateTo({
        url: '../../pages_userActivity/fruit/fruit',
      });
    },
    //去TA是谁
    toOtherUser2() {
    ...
    goSafeRoad() {
      uni.navigateTo({
        ...
        // url: '../../pages_userActivity/safeRoad/safeRoad'
      });
    },
    //去空间巡游
    goSpaceRun() {
      uni.navigateTo({
        url: '../../pages_userActivity/spaceRun/spaceRun',
      });
    },
    //去随心写
    goIndex2() {
    ...
    async getuserInfo() {
      ...
      //红点
      this.getRedDot(res.result.uid, 1);
      this.getRedDot(res.result.uid, 2);
      this.getRedDot(res.result.uid, 3);
      // 关注
    ...
    async getRedDot(uid, type) {
      const res = await redDot({
        uid: uid,
        type: type,
        t: Date.parse(new Date()),
      });
      console.log(
        `请求${type === 1 ? '聊天' : type === 2 ? '消息' : '瓶子'}红点`,
      );
      console.log(res);
      if (res.code !== 0) {
        uni.$u.toast(res.msg);
...
.box-title {
  ...
  .people-and-do-some {
    background: url('https://www.zairongyifang.com:8080/filePath/app/20245/compressed_37f8cc8b7d.png')
      no-repeat;
