				...
				<div class="my-info">
					...
					<div class="cost-start">
						<div class="cost-level">
							<img class="level-img" :src="vipLevel === 1 ? '../../static/vip-1.png' : vipLevel === 2 ? '../../static/vip-2.png' : '../../static/vip-3.png'" alt="" />
						...
						<div class="cost-step">
							<u-line-progress :percentage="percentage" height="8" inactiveColor="#fff" activeColor="#FEDA7A"></u-line-progress>
						</div>
					</div>
					<div class="infos-3">
						<div class="contorl-1">
